...
import CaseIcon from "../../../../assets/cases/jack_in_the_case.webp";

import { PossiblePrizes } from "./PossiblePrizes";

// Заменяем импорт useJackRoulette на useUnifiedRoulette
import { useUnifiedRoulette } from "@/hooks/useUnifiedRoulette";
import { generateRoulette, startRolling } from "./generateRoulette";

//rare gift
import JackInTheBox from "../../../../assets/prize/jack_in_the_box.webp";
...
export const JackCase: React.FC = () => {
  ...
  // Заменяем useJackRoulette на useUnifiedRoulette
  const {
    winningItemId,
    gameStarted,
    isModalOpen,
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        ...
        >
          {language === 'ru' ? "Испытай удачу - 40" : "Try Your Luck - 40"}
