...
import CaseIcon from "../../../../assets/cases/top_hat_case.webp";
...
//rare gift
import topHatRare from "../../../../assets/prize/tophatRare.webp";
...
export const TopHatCase: React.FC = () => {
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        ...
        >
          {language === 'ru' ? "Испытай удачу - 65" : "Try Your Luck - 65"}
