...
const ModalPrize: React.FC<ModalPrizeProps> = ({
  isOpen,
  winningItem,
  onClose,
  onSell,
  ...
  const handleClaimPrize = async () => {
    ...
    const isRare = winningItem.id === "9996";
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-box">
        ...
        {language === 'ru' ?
          <button onClick={handleClaimPrize} className="modal-button claim" disabled={isProcessing}>
        ...
        {language === 'ru' ?
          <button onClick={onSell} className="modal-button sell" disabled={isProcessing}>
