...
import CaseIcon from "../../../../assets/cases/durov's_cap_case.webp";

import { PossiblePrizes } from "./PossiblePrizes";

// Заменяем импорт useCapRoulette на useUnifiedRoulette
import { useUnifiedRoulette } from "@/hooks/useUnifiedRoulette";
import { generateRoulette, startRolling } from "./generateRoulette";

//rare gift
import DurovCap from "../../../../assets/prize/durovcap.webp";
import { useLanguage } from "@/components/LanguageContext";
import { fetchCaseStatus } from "@/hooks/fetchCaseStatus";

const items = {
  1: { id: "5170233102089322756", img: Bear, price: 15, chance: "0.5%"},
  2: { id: "5170145012310081615", img: Heart, price: 15, chance: "0.5%"},
  3: { id: "5170250947678437525", img: Gift, price: 25, chance: "2%"},
  4: { id: "5170521118301225164", img: Gem, price: 100, chance: "20%"},
  5: { id: "5170690322832818290", img: Ring, price: 100, chance: "20%"},
  6: { id: "5168043875654172773", img: Trophy, price: 100, chance: "20%"},
  ...
  10: { id: "5168103777563050263", img: RoseSingle, price: 25, chance: "2%"},
  11: { id: "6028601630662853006", img: Champangne, price: 50, chance: "2%"},
  12: { id: "5782984811920491178", img: happyBirth, price: 350, chance: "25%"},
  9997: {
    id: "9997",
    img: DurovCap,
    price: 9999,
    chance: "2%",
    collection: "Durov's Cap #754",
    model: "Frosthom",
    backdrop: "Emerald",
    symbol: "Owl",
  },
...
export const CapCase: React.FC = () => {
  ...
  // Заменяем useCapRoulette на useUnifiedRoulette
  const {
    winningItemId,
    gameStarted,
    isModalOpen,
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        <Button
          onClick={async () => {
            const isBlocked = await fetchCaseStatus(3); // 🔥 живая проверка
        ...
        >
          {language === 'ru' ? "Испытай удачу - 500" : "Try Your Luck - 500"}
