...
// Массив ID предметов, которые могут выпасть в Cap кейсе
const availableCapItems = [
  "5170233102089322756", // Bear
  "5170145012310081615", // Heart
  "5170250947678437525", // Gift
  "5170521118301225164", // Gem
  "5170690322832818290", // Ring
  "5168043875654172773", // Trophy
  "5170564780938756245", // Rocket
  "5170314324215857265", // Roses
  "5170144170496491616", // Cake
  "5168103777563050263", // RoseSingle
  "6028601630662853006", // Champangne
  "5782984811920491178", // happyBirth
  "9997", // Durov's Cap
];
...
export function generateRoulette(winningId?: string) {
  ...
  // Создаем массив всех доступных ID для Cap кейса, кроме выигрышного
  const availableIds = availableCapItems.filter(id => id !== winningId);
