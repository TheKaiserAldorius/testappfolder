...
import CaseIcon from "../../../../assets/cases/signet_ring_case.webp";
...
//rare gift
import signetRingRare from "../../../../assets/prize/signetRingRare.webp";
...
export const SignetRingCase: React.FC = () => {
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        <Button
          onClick={async () => {
            // const isBlocked = await fetchCaseStatus(11); // 🔥 живая проверка
