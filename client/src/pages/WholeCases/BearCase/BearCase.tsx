...
import CaseIcon from "../../../../assets/cases/bear_case.webp";
...
//rare gift
import bearRare from "../../../../assets/prize/bearRare.webp";
...
export const BearCase: React.FC = () => {
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        ...
        >
          {language === 'ru' ? "Испытай удачу - 70" : "Try Your Luck - 70"}
