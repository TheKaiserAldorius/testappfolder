...
import CaseIcon from "../../../../assets/cases/heart_case.webp";

import { PossiblePrizes } from "./PossiblePrizes";

// Заменяем импорт useHeartRoulette на useUnifiedRoulette
import { useUnifiedRoulette } from "@/hooks/useUnifiedRoulette";
import { generateRoulette, startRolling } from "./generateRoulette";

//rare gift
import HeartCookie from "../../../../assets/prize/heartCookie.webp";
...
export const HeartCase: React.FC = () => {
  ...
  // Заменяем useHeartRoulette на useUnifiedRoulette
  const {
    winningItemId,
    gameStarted,
    isModalOpen,
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        ...
        >
          {language === 'ru' ? "Испытай удачу - 35" : "Try Your Luck - 35"}
