...
// import CaseIcon from "../../../../assets/cases/gem_case.webp";

// import { PossiblePrizes } from "./PossiblePrizes";

// import { useGemRoulette } from "@/hooks/useGemRoulette";

// import { useLanguage } from "@/components/LanguageContext";
// import { fetchCaseStatus } from "@/hooks/fetchCaseStatus";

// const items = {
//   1: { id: "5170233102089322756", img: Bear, price: 15, chance: "20.35%" },
//   2: { id: "5170145012310081615", img: Heart, price: 15, chance: "20.35%" },
//   3: { id: "5170250947678437525", img: Gift, price: 25, chance: "25%" },
//   4: { id: "5170521118301225164", img: Gem, price: 100, chance: "1.1%"},
//   5: { id: "5170690322832818290", img: Ring, price: 100, chance: "1.1%"},
//   6: { id: "5168043875654172773", img: Trophy, price: 100, chance: "1.1%"},
//   7: { id: "5170564780938756245", img: Rocket, price: 50, chance: "1.32%"},
//   8: { id: "5170314324215857265", img: Roses, price: 50, chance: "1.32%"},
//   9: { id: "5170144170496491616", img: Cake, price: 50, chance: "1.32%"},
//   10: { id: "5168103777563050263", img: RoseSingle, price: 25, chance: "25%"},
//   11: { id: "6028601630662853006", img: Champangne, price: 50, chance: "1.32%"},
//   12: { id: "5782984811920491178", img: happyBirth, price: 350, chance: "0.72%"},
// };

// export const GemCase: React.FC = () => {
...
//     handleSell,
//     idGiftNumber,
//   } = useGemRoulette(user?.id, user?.username);
