...
import CaseIcon from "../../../../assets/cases/skeleton_skull_case.webp";

import { PossiblePrizes } from "./PossiblePrizes";

// Заменяем импорт useSkeletonRoulette на useUnifiedRoulette
import { useUnifiedRoulette } from "@/hooks/useUnifiedRoulette";
import { generateRoulette, startRolling } from "./generateRoulette";

//rare gift
import skeletonRare from "../../../../assets/prize/skeletonRare.webp";

import { useLanguage } from "@/components/LanguageContext";
import { fetchCaseStatus } from "@/hooks/fetchCaseStatus";

const items = {
  1: { id: "5170233102089322756", img: Bear, price: 15, chance: "4.5%"},
  2: { id: "5170145012310081615", img: Heart, price: 15, chance: "4.5%"},
  3: { id: "5170250947678437525", img: Gift, price: 25, chance: "15%"},
  4: { id: "5170521118301225164", img: Gem, price: 100, chance: "2%"},
  5: { id: "5170690322832818290", img: Ring, price: 100, chance: "2%"},
  6: { id: "5168043875654172773", img: Trophy, price: 100, chance: "2%"},
  ...
  10: { id: "5168103777563050263", img: RoseSingle, price: 25, chance: "15%"},
...
export const SkeletonCase: React.FC = () => {
  ...
  // Заменяем useSkeletonRoulette на useUnifiedRoulette
  const {
    winningItemId,
    gameStarted,
    isModalOpen,
  ...
  return (
    <Page back={true}>
      ...
      <div className="start-button"> 
        <Button
          onClick={async () => {
            // const isBlocked = await fetchCaseStatus(1); // 🔥 живая проверка
        ...
        >
          {language === 'ru' ? "Испытай удачу - 75" : "Try Your Luck - 75"}
